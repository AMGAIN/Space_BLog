  ...
  return (
    <div className=' bg-gray-800 text-white text-2xl'>
      <div className=" mb-2 flex mx-12 pt-12 justify-between items-center p-1rem ">
        <div className=" sm:p-6 lg:w-[50%] md:w-full relative border-t border-l z-2 w-[800px]">
          ...
          <div className='lg:hidden xl:w-[50%] shadow-white transition-shadow duration-300 hover:cursor-pointer hover:shadow-[0_0_20px_white]'>
            <Image className="border " src={post.img} alt="hero_Image" priority />
          </div>
          <p className="mt-4 text-lg text-justify line-clamp-2">{post.desc}</p>
        </div>
        <div className='hidden lg:block lg:w-[50%] shadow-white transition-shadow duration-300 hover:cursor-pointer hover:shadow-[0_0_20px_white]'>
          <Image className="border " src={post.img} alt="hero_Image" priority />
        </div>
      </div>
